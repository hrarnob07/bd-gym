...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="" class="logo">
            ...
            <span class="logo-lg"><b>Admin</b> GYM</span>
        </a>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{url('asset/backend/dist/img/user.png')}}" class="user-image" alt="User Image">
                    ...
                    <li>
                        <a href="#" data-toggle="control-sidebar"><i class="fa fa-logout"></i> logout</a>
                    </li>
                </ul>
            </div>
